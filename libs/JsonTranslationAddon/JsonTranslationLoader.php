...
namespace ILIAS\Plugin\SkinToggle\Libs\JsonTranslationLoader;
 ...
 * @package ILIAS\Plugin\SkinToggle\Libs\JsonTranslationLoader
 */
class JsonTranslationLoader extends ilPluginLanguage
{
    /**
     * @var string
     */
    ...
    public function __construct(ilPluginInfo $pluginInfo)
    {
