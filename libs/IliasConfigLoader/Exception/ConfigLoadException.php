...
namespace ILIAS\Plugin\SkinToggle\Libs\IliasConfigLoader\Exception;

use Exception;
use ILIAS\Plugin\SkinToggle\Libs\IliasConfigLoader\Model\UnloadableProperty;

/**
 * Class ConfigLoadException
 * @package ILIAS\Plugin\SkinToggle\Exception
